...
from RNCapsGAN.model import Generator, Discriminator
from args.RNCapsGAN_train_arg_parser import CycleGANTrainArgParser
from dataset.vc_dataset import VCDataset
from RNCapsGAN.utils import decode_melspectrogram, get_mel_spectrogram_fig
from logger.train_logger import TrainLogger
from saver.model_saver import ModelSaver


class RRCapsGANVCTraining(object):
    """Trainer for RRCapsGAN-VC
    """
