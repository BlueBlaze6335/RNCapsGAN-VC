        ...
        for i, sample in enumerate(tqdm(self.test_dataloader)):
            ...
            if self.model_name == 'generator_A2B':
                ...
                save_path = os.path.join(self.converted_audio_dir,
                                         f"{i}-converted_{self.speaker_A_id}_to_{self.speaker_B_id}.wav")
                ...
                save_path = os.path.join(self.converted_audio_dir,
                                         f"{i}-converted_{self.speaker_B_id}_to_{self.speaker_A_id}.wav")
